...
func (b *backendWithUnimplementedPaging) ListBucket(accessKey string, name string, prefix *gofakes3.Prefix, page gofakes3.ListBucketPage) (*gofakes3.ObjectList, error) {
	if !page.IsEmpty() {
		return nil, gofakes3.ErrInternalPageNotImplemented
	}
	return b.Backend.ListBucket(accessKey, name, prefix, page)
}
